...
| [protoLabsAI/protoAgent](https://github.com/protoLabsAI/protoAgent) | Template repo for a lean, A2A-native agent on LangGraph — fork it, ship a React operator console, extend via git-URL plugins instead of forking the core | ![GitHub stars](https://img.shields.io/github/stars/protoLabsAI/protoAgent?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/protoLabsAI/protoAgent) |
