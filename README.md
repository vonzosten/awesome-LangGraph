...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) | MCP server for AI agent trust scoring on Solana. Score agents, run preflight checks, and issue on-chain trust receipts before deploying into multi-agent workflows. Zero-install: `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}`. PyPI: `pip install twzrd-agent-intel` | [![PyPI](https://img.shields.io/pypi/v/twzrd-agent-intel)](https://pypi.org/project/twzrd-agent-intel/) |
