...
| [TrustBoost PII Sanitizer](https://github.com/teodorofodocrispin-cmyk/TrustBoost-PII-Sanitizer) | Context-aware PII sanitization layer for LangGraph pipelines. Redacts emails, national IDs (RFC/CPF/CUIT/RRN), API keys, and financial data before text reaches LLMs. Every paid sanitization anchored on Solana — verifiable at `/verify/{anchor_tx}`. 8 languages, x402 compatible, fail-closed. MIT. | ![GitHub stars](https://img.shields.io/github/stars/teodorofodocrispin-cmyk/TrustBoost-PII-Sanitizer?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/teodorofodocrispin-cmyk/TrustBoost-PII-Sanitizer) |
