...
| [agentrhq/authsome](https://github.com/agentrhq/authsome) | Local credential broker for AI agents — log in once via OAuth2 or API key, encrypted vault stores credentials, a loopback HTTPS proxy injects them into outbound provider requests so LangGraph agents never touch raw secrets. 45 providers bundled (GitHub, Google, OpenAI, Linear, Slack, Notion, Resend, Stripe, ...) | ![GitHub stars](https://img.shields.io/github/stars/agentrhq/authsome?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/agentrhq/authsome) |
