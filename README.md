...
| [byGao/GraphLoupe](https://github.com/byGao/GraphLoupe) | Self-hosted node-level LangGraph debugger for VS Code — breakpoints, state diff, time-travel, per-node token economy, and manual inference (paste any chat's answer to resume a paused node) | ![GitHub stars](https://img.shields.io/github/stars/byGao/GraphLoupe?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/byGao/GraphLoupe) |
