...
| [Charbelto/loopguard](https://github.com/Charbelto/loopguard) | A lightweight, framework-agnostic loop prevention and agentic guardrails engine with LangChain, LangGraph, and LlamaIndex integrations. | ![GitHub stars](https://img.shields.io/github/stars/Charbelto/loopguard?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/Charbelto/loopguard) |
