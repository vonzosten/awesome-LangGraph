...
| Project | Description | GitHub Stars |
|---|---|---|
| [aporthq/aport-integrations](https://github.com/aporthq/aport-integrations) | Agent identity and policy enforcement examples for LangChain and CrewAI tool calls, adding pre-action authorization guardrails. | ![GitHub stars](https://img.shields.io/github/stars/aporthq/aport-integrations?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/aporthq/aport-integrations) |
