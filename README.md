...
| [DanceNitra/mnemo](https://github.com/DanceNitra/mnemo) | Self-correcting memory layer with a LangGraph `BaseStore` adapter — corrections supersede the old value, a restated stale value can't resurrect it, and the store keeps queryable value history | ![GitHub stars](https://img.shields.io/github/stars/DanceNitra/mnemo?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/DanceNitra/mnemo) |
