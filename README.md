...
| [maximem-ai/maximem_synap_sdk](https://github.com/maximem-ai/maximem_synap_sdk) | Synap — managed long-term memory layer for AI agents. Includes `SynapStore` (LangGraph `BaseStore`) and `SynapCheckpointSaver` for cross-thread memory + a `create_synap_node` for state injection | ![GitHub stars](https://img.shields.io/github/stars/maximem-ai/maximem_synap_sdk?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/maximem-ai/maximem_synap_sdk) |
