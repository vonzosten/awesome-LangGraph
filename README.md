...
| [RenanMiqueloti/agents-AI](https://github.com/RenanMiqueloti/agents-AI) | Streamlit dashboard with 5 LangGraph agents (basic, memory, tools, RAG, HITL via `interrupt()` + `MemorySaver`), custom MCP server, and 25 LLM-as-judge evals. Multi-provider: Ollama, Claude, OpenAI. | ![GitHub stars](https://img.shields.io/github/stars/RenanMiqueloti/agents-AI?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/RenanMiqueloti/agents-AI) |
