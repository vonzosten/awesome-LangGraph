...
| [tejonish/Rag_bot](https://github.com/tejonish/Rag_bot) | AI Hiring Copilot built with LangGraph featuring multi-agent orchestration, conditional routing, resume–job matching, ATS analysis, skill-gap detection, and personalized learning roadmaps. | ![GitHub stars](https://img.shields.io/github/stars/tejonish/Rag_bot?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/tejonish/Rag_bot) |
