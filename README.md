...
| [Pushary/pushary-langgraph](https://github.com/Pushary/pushary-langgraph) | Human-in-the-loop over LangGraph's interrupt(): a real person approves on their phone, fail-closed, over a durable ledger. | ![GitHub stars](https://img.shields.io/github/stars/Pushary/pushary-langgraph?style=social) |
