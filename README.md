...
| [shantanu-deshmukh/chunktuner](https://github.com/shantanu-deshmukh/chunktuner) | Python library + CLI + MCP server to benchmark chunking strategies (semantic, recursive, PDF layout, code AST, etc.), score retrieval for RAG QA, and recommend configs before you lock in a LangGraph retrieval pipeline | ![GitHub stars](https://img.shields.io/github/stars/shantanu-deshmukh/chunktuner?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/shantanu-deshmukh/chunktuner) |
