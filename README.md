...
| [future-agi/traceAI](https://github.com/future-agi/traceAI) | OpenTelemetry-native tracing framework for LangChain/LangGraph and 20+ other AI frameworks. Captures prompts, tokens, latency, and errors with auto-instrumentation. | ![GitHub stars](https://img.shields.io/github/stars/future-agi/traceAI?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/future-agi/traceAI) |
| [future-agi/future-agi](https://github.com/future-agi/future-agi) | Open-source self-hostable LLMOps platform unifying tracing, evals, simulations, datasets, gateway, and guardrails for LangChain/LangGraph applications. | ![GitHub stars](https://img.shields.io/github/stars/future-agi/future-agi?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/future-agi/future-agi) |
