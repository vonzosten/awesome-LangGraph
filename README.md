...
| [dbe006/rugguard-langgraph-agent](https://github.com/dbe006/rugguard-langgraph-agent) | Pre-trade rug-check StateGraph node. Returns block/caution/allow on a token before an agent buys it. Pay-per-call via x402 USDC on Base, no API key. | ![GitHub stars](https://img.shields.io/github/stars/dbe006/rugguard-langgraph-agent?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/dbe006/rugguard-langgraph-agent) |
