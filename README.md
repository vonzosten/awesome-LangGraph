...
| [dakera-ai/dakera-mcp](https://github.com/dakera-ai/dakera-mcp) | Self-hosted MCP agent memory server for LangGraph. Provides persistent, decay-weighted external memory across agent runs with HNSW vector search and cross-agent knowledge sharing. | ![GitHub stars](https://img.shields.io/github/stars/dakera-ai/dakera-mcp?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/dakera-ai/dakera-mcp) |
