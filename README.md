...
| [future-agi/future-agi](https://github.com/future-agi/future-agi) | Open-source platform for tracing, evaluating, and guardrailing LangGraph agents with patch-based instrumentation, graph-topology capture, 70+ eval metrics, and LLM-as-judge | ![GitHub stars](https://img.shields.io/github/stars/future-agi/future-agi?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/future-agi/future-agi) |
