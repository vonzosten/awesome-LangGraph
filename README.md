...
| [feder-cr/invisible_playwright](https://github.com/feder-cr/invisible_playwright) | Playwright wrapper for a stealth-patched Firefox 150 binary. Drop-in `Browser` for LangGraph agents that need to scrape sites with anti-bot guardrails (reCAPTCHA, FingerprintPro, Cloudflare). | ![GitHub stars](https://img.shields.io/github/stars/feder-cr/invisible_playwright?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/feder-cr/invisible_playwright) |
