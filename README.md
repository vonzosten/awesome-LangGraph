...
| [twzrd-sol/wzrd-final](https://intel.twzrd.xyz) | TWZRD Agent Intel — MCP trust-scoring server for x402 payment agents on Solana. Free preflight agent trust check + signed V5 trust receipt via USDC micropayment (<1s). Tools: `resolve_agent`, `score_agent`, `get_trust_receipt`, `verify_trust_receipt` | ![GitHub stars](https://img.shields.io/github/stars/twzrd-sol/wzrd-final?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/twzrd-sol/wzrd-final) |
