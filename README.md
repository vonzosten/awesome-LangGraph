...
| [kamaalg/agent2model](https://github.com/kamaalg/agent2model) | Compiles a LangGraph StateGraph (or YAML flowchart) into a small model's weights so it runs the procedure with no orchestrator; ships a procedure-adherence eval harness | ![GitHub stars](https://img.shields.io/github/stars/kamaalg/agent2model?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/kamaalg/agent2model) |
